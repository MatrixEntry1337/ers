...
class ReimDAO{
	...
	List<Reim> getUserReimsByStatus(int userId, String status) throws SQLException{
		List<Reim> list = new ArrayList<Reim>();
		String sql = "SELECT REIMB_ID, REIMB_AMOUNT,"
				+ " s.REIMB_STATUS_ID, s.REIMB_STATUS, t.REIMB_TYPE_ID, t.REIMB_TYPE,"
				+ " REIMB_DESCRIPTION, REIMB_SUBMITTED, REIMB_RESOLVED,"
	...
	List<Reim> getUserReimsByType(int userId, String status) throws SQLException{
		List<Reim> list = new ArrayList<Reim>();
		String sql = "SELECT REIMB_ID, REIMB_AMOUNT,"
				+ " s.REIMB_STATUS_ID, s.REIMB_STATUS, t.REIMB_TYPE_ID, t.REIMB_TYPE,"
				+ " REIMB_DESCRIPTION, REIMB_SUBMITTED, REIMB_RESOLVED,"
	...
	List<Reim> getAllReimsByStatus(String status)throws SQLException {
	...
	List<Reim> getAllReimsByType(String type)throws SQLException {
